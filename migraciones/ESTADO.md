...
| 008 | [`008_gastos_invitar_miembro.sql`](./008_gastos_invitar_miembro.sql) | Función `claim_member` para vincular un enlace de invitación a un miembro fantasma concreto | ⏳ Pendiente |
